...
from app.tools.agentic_loop import (
    APIProvider,
    sampling_loop,
)
from app.tools import ToolResult, ToolVersion
...
async def main():
    ...
    with st.sidebar:
        ...
        st.text_area(
            ...
            help="Additional instructions to append to the system prompt. see app/tools/agentic_loop.py for the base system prompt.",
